...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnCameraIdleListener {
    ...
    private void setupMapFeatures() {
        ...
        addMapMarker(new LatLng(-1.00980336425228, -79.46753894375158), "Shake The Donut", "Cafeteria \n Direccion: Av. SHAKE THE DONUT \n Abre: 08:00 am Cierra: 10:00 pm", R.mipmap.ic_cafeteria);
        addMapMarker(new LatLng(-1.0108414790287659, -79.47047791799375), "KONITOS PIZZA", "Pizza", R.mipmap.ic_pizzeria);
        addMapMarker(new LatLng(-1.0116926846991625, -79.4668864858666), "BUNKER FRUIT", "Restaurante", R.mipmap.ic_restaurante);
        ...
        addMapMarker(new LatLng(-1.0116926846991625, -79.46668349447533),"Encebollado Pique y Pase","Restaurante", R.mipmap.ic_restaurante);
        addMapMarker(new LatLng(-1.0134964709572454, -79.46930492745352),"Lokos D' Asar","Restaurante", R.mipmap.ic_restaurante);
        addMapMarker(new LatLng(-1.0130228694934307, -79.4668543112106),"Toque Marinero","Restaurante\n Direccion: Av. Quito \n Abre: 07:00 am Cierra: 13:00 pm", R.mipmap.ic_restaurante);
        addMapMarker(new LatLng(-1.0141128250964173, -79.46832758691284),"Sweet Land - Quevedo","Heladeria", R.mipmap.ic_heladeria);
        addMapMarker(new LatLng(-1.0141242636177403, -79.46831397754428),"Las Delicias Del Olimpo","Restaurante", R.mipmap.ic_restaurante);
